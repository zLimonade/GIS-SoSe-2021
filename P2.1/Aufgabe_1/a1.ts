...
function a1(): void {           /* Funktion wird deklariert. Ihr Name ist "a1". Ihr werden keine Parameter übergeben. 
                                   Sie besitzt den Rückgabetypen "void", welcher besagt, dass "a1" nichts zurückgibt. */

                                // Rumpf der Methode "a1": Anweisungen der Funktion "a1".

    let x: string = "Alles";    /* Gleichzeitige Deklaration und Zuweisung, also Initialisierung, der lokalen Variable "x". 
...
function func1(): void {        // Deklaration der Funktion "func1".
...
function funcAlles(): void {
    console.log("Alles!");
}

function funcGute(): void {
    console.log("Gute!");
}

function funcKlar(): void {
    console.log("klar?");
}

function funcLogo(): void {
    console.log("Logo!");
}